...
def build_model(sp: spm.SentencePieceProcessor, args: argparse.Namespace) -> Transformer:
...
def load_checkpoint(model: Transformer, checkpoint_path: str | Path, device: torch.device) -> None:
...
def greedy_translate(
    ...
    *,
    ...
    # Remove leading BOS and optional trailing EOS.
